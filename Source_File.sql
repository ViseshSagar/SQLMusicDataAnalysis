...
-- sum of invoice totals. Return city name & sum of all invoice totals
...
-- Who is the best customer? The customer who has spent the most money will be declared thee best customer.
...
-- Let's invite the artists who've written the most rock music in our dataset.
...
-- Find how much amount is spent by each customer on artists? Write a query to return each customer name, 
-- artist name and total spent

-- Used CTE (Common Table Expression). This creates a new table using the queries given inside it.
